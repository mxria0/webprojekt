...
const VeranstaltungsRouteController = express.Router();
 ...
 */
VeranstaltungsRouteController.use((req, res, next) => {
  const links = [
    {
      rel: "self",
...
VeranstaltungsRouteController.get("/", (req, res) => {
  const apiResponse = {
 ...
 */
VeranstaltungsRouteController.get("/beers", (req, res) => {
  const beerResponse = {
    items: beers,
 ...
 */
VeranstaltungsRouteController.post("/beers", (req, res) => {
 ...
 */
VeranstaltungsRouteController.get("/beers/:id", (req, res) => {
  const { id } = req.params;
 ...
 */
VeranstaltungsRouteController.delete("/beers/:id", (req, res) => {
  const { id } = req.params;
 ...
 */
VeranstaltungsRouteController.put("/beers/:id", (req, res) => {
  const requiredProperties = ["name", "taste"];
  const validation = validateProperties(requiredProperties, req.body);
  if (validation.isValid) {
    const { id } = req.params;
...
export default VeranstaltungsRouteController;
